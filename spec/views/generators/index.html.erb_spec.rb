...
RSpec.describe 'generators/index', type: :view do
  it 'displays the front-end developer test project page' do
    ...
    expect(rendered).to have_selector('h1.border-bottom.border-2.fs-1.fw-bold.pb-3', text: 'Front-end developer test project')
    expect(rendered).to have_selector('p.main-txt', text: 'Your goal is to make a page that looks exactly this one, and has the ability to create H1 text simply by typing / then 1, then typing text, and hitting enter.')
